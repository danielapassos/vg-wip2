...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  let chatMessages = [];
  let scrollToDiv;
  return `<div class="flex flex-col pt-4 w-full px-8 items-center gap-2"><div><h1 class="text-2xl font-bold w-full text-center">Vehicle Genius Chatbot</h1>
		<p class="text-sm italic">Work in progress</p></div>
    ...
    {
      type: "assistant",
      message: "Welcome to Vehicle Genius! Thanks for completing the onboarding. We are in the process of creating your Genius Report now. In the meantime, access the Genius chatbot below."
    },
    {},
    {}
  )}
